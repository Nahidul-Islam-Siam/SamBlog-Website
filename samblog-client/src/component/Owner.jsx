...
const Owner = () => {
	...
	<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
		<img src="https://lh3.googleusercontent.com/a/ACg8ocJj64KhuCHLY66j6G1t2BYCusmzEml11bfPsqL_-4wQbQtAUZsl=s96-c" alt="" className="border-2 border-sky-700 hover:border-amber-300 self-center flex-shrink-0 w-24 h-24 rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-300" />
		<div className="flex flex-col">
			<h4 className="text-lg font-semibold text-center md:text-left">Nahidul Islam Siam - Chief Executive Officer

</h4>
			<blockquote class="italic text-lg text-gray-700">
      "Our blog is more than just a platform for sharing information; it's a community where ideas are exchanged, stories are told, and connections are made. I am committed to fostering an environment where creativity thrives and our readers find value and inspiration in every post. Together, we are shaping the future of digital storytelling."
    </blockquote>
		</div>
	</div>
